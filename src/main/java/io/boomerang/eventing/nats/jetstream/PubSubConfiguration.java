...
/**
 * The {@link PubSubConfiguration} class specifies the configuration for managing a NATS Jetstream
 * {@code Stream} and {@code Consumer} on the server. Properties are set using a
 * {@link PubSubConfiguration.Builder Builder}.
 * 
 * @since 0.2.0
 */
final public class PubSubConfiguration {
   ...
   * {@link PubSubConfiguration#automaticallyCreateStream automaticallyCreateStream} is
   * {@code true}.
   * 
   * @since 0.2.0
   */
  ...
  /**
   * The NATS Jetstream {@code Consumer} will be created automatically on the server if the value of
   * {@link PubSubConfiguration#automaticallyCreateConsumer automaticallyCreateConsumer} is
   * {@code true}.
   * 
   * @since 0.2.0
   */
   ...
   * @since 0.2.0
   */
  public PubSubConfiguration(Boolean automaticallyCreateStream,
      Boolean automaticallyCreateConsumer) {
  ...
  /**
   * {@link PubSubConfiguration} is created using a {@link Builder}. The builder supports chaining
   * and will create a default set of options if no methods are called.
   * 
   * <br/>
   * <br/>
   * 
   * {@code new PubSubConfiguration.Builder().build()} will create a new {@link PubSubConfiguration}
   * with default values.
   * 
   * @since 0.2.0
   */
  public static class Builder {
    ...
    /**
     * The NATS Jetstream {@code Stream} will be created automatically on the server if the value of
     * {@link PubSubConfiguration.Builder#automaticallyCreateStream automaticallyCreateStream} is
     * {@code true}.
     * 
    ...
    /**
     * The NATS Jetstream {@code Consumer} will be created automatically on the server if the value
     * of {@link PubSubConfiguration.Builder#automaticallyCreateConsumer
